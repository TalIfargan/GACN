...
LEARNING_RATE = 1e-05
SEED = 42
RUN_NAME = 'bert fine tuned for classification using natural and synthetic clinical notes'
...
data_files = {
    'train': './outputs/generation_model/combined_clinical_notes.csv',
    'eval': './data/eval.csv'
}
...
trainer.train()
trainer.save_model(output_dir='./outputs/combined_classification_model')
